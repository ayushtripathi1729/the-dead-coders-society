...
export function Button({ className, asChild, variant = "primary", ...props }: ButtonProps) {
  ...
  return (
    <Comp
      className={cn(
        "electric-border clip-arena inline-flex min-h-11 max-w-full min-w-0 shrink items-center justify-center gap-2 overflow-hidden px-4 py-2 text-center font-[family-name:var(--font-display)] text-[11px] uppercase leading-tight tracking-[0.16em] transition duration-300 disabled:cursor-not-allowed disabled:opacity-50 [&_svg]:shrink-0",
