    ...
    <>
      ...
      <main className="mx-auto w-full max-w-7xl px-4 pb-20 pt-28 sm:px-6">
        ...
        <section className="mt-8 grid gap-5 lg:grid-cols-3">
          ...
          <div className="section-band p-5">
            <h2 className="section-rune font-[family-name:var(--font-display)] text-xl uppercase">Problem First Solves</h2>
            <div className="mt-4 grid gap-3">
              ...
              {!contest.problems.length && <p className="text-sm text-zinc-500">No problem first solves recorded.</p>}
            </div>
          </div>
          <div className="section-band p-5">
